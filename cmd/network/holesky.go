...
var Holesky = &common.Spec{
	...
	Config: common.Config{
		...
		GENESIS_FORK_VERSION:                 common.Version{0x01, 0x01, 0x70, 0x00},
		GENESIS_DELAY:                        300,
		ALTAIR_FORK_VERSION:                  common.Version{0x02, 0x01, 0x70, 0x00},
		ALTAIR_FORK_EPOCH:                    common.Epoch(0),
		BELLATRIX_FORK_VERSION:               common.Version{0x03, 0x01, 0x70, 0x00},
		BELLATRIX_FORK_EPOCH:                 common.Epoch(0),
		CAPELLA_FORK_VERSION:                 common.Version{0x04, 0x01, 0x70, 0x00},
		CAPELLA_FORK_EPOCH:                   common.Epoch(256),
		DENEB_FORK_VERSION:                   common.Version{0x05, 0x01, 0x70, 0x00},
		DENEB_FORK_EPOCH:                     common.Epoch(29696),
